                                    ...
                                    <form class="forms-sample" action="{{ url('admin/store/level') }}" method="POST">
                                      ...
                                      @method('post')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                            <input type="text" class="form-control" id="exampleInputNationality" name="EduLevelName" value="{{ old('EduLevelName') }}"
                                        ...
                                        <a href="{{ url('admin/index/level') }}" > <button type="button" class="btn btn-secondary">Back</button></a>
