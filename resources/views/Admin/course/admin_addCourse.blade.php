                                ...
                                @endif
                                    ...
                                    <form class="forms-sample" action="{{ url('admin/store/course') }}" method="POST">
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <br>
                                            <input type="text" class="form-control" name="MaterialName" value="{{ old('MaterialName') }}" id="exampleInputName" placeholder="Course Name">
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <br>
                                            <input type="text" class="form-control" name="code" value="{{ old('code') }}" id="exampleInputCode" placeholder="Course Code">
