                                ...
                                @endif
                                    ...
                                    <form class="forms-sample" action="{{ url('admin/update/course') }}" method="POST">
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <br>
                                            <input type="text" class="form-control" name="MaterialName" value="{{ $data->MaterialName }}" id="exampleInputName" placeholder="Course Name">
                                           
                                        </div>
                                        <div class="form-group" >
                                          <label for="exampleInputCode"> Course Code</label>
                                          <br>
                                          <input type="text" class="form-control" name="code" value="{{ $data->code }}" id="exampleInputCode" placeholder="Course Code">
