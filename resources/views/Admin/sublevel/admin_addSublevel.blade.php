                                ...
                                @endif
                                    ...
                                    <form class="forms-sample" action="{{ url('admin/store/sublevel') }}" method="POST">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <select class="form-control"  name="LevelId"  id="exampleSelectStage" style="width: 50%;">
                                           @foreach ($lev as $leve )
                                               <option value="{{ $leve->id }}">{{ $leve->EduLevelName }}</option>
                                           @endforeach 
                                        </select>
                                      </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                            <input type="text" class="form-control" id="exampleInputNationality"  name="SubLevelName" value="{{ old('SubLevelName') }}"
