            ...
            <div class="col-md-12 grid-margin">
              ...
              <div class="card col-md-8 grid-margin">
                <p class="card-description" style="margin: 20px;">
                    <a href="{{ url('admin/create/district') }}" > <button type="button" class="btn btn-primary"> Add District</button></a>
                  </p>
                        ...
                        @foreach ($data as $p)
                           <td>{{ $p->Id }} </td>
                            ...
                            <td>
                                ...
                                <a href="{{ url('admin/edit/district/'. $p->Id ) }}"> <button type="button" class="btn btn-primary"  style="margin-right: 10px;"> Edit</button></a>
