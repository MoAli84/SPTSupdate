                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                ...
                                @endif
                                    ...
                                    <form class="forms-sample" action="{{ url('admin/update/town') }}" method="POST">
                                      @csrf
                                      @method('post')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                            <input type="text" class="form-control" id="exampleInputNationality" name="TownName" value="{{$data->TownName}}"
                                                placeholder="Town">
