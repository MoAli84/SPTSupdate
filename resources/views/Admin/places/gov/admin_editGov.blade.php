          ...
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
                ...
                @endif
                    ...
                    <form class="forms-sample" action="{{ url('admin/update/governorate') }}" method="POST">
                      @csrf
                      @method('post')
                      <input type="hidden" name="id" value="{{ $data->Id }}">
                        ...
                        <div class="form-group" >
                            ...
                            <br>
                            <input type="text"  class="form-control" name="GovName" value="{{ $data->GovName }}" id="exampleInputYear" placeholder="Governorate">
                      ...
                      <a href="{{ url('admin/index/governorate') }}" > <button type="button" class="btn btn-secondary">Back</button></a>
